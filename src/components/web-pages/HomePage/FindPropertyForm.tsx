...
const tabConfig: Record<SearchTab, { label: string; placeholder: string }> = {
    buy: { label: "Buy", placeholder: "Search for properties to buy" },
    rent: { label: "Rent", placeholder: "Search for properties for rent" },
    sold: { label: "Sold", placeholder: "Search for sold properties" },
};

const FindPropertyForm = () => {
    ...
    return (
        <div className="relative z-10 w-full max-w-3xl mx-auto px-4 sm:px-6 flex flex-col items-center gap-8">
            ...
            {/* Headline */}
            <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-semibold text-center leading-tight drop-shadow-md">
                Property Simplified
            </h1>
